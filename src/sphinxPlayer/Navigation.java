...
/**
 * Created by Celeron on 1/20/2017.
 */
public class Navigation extends Radar {
 ...
 */
    ...
    private static void drawGridDots() throws GameActionException {
        for (int y = 0; y < gridY; y++) {
            for (int x = 0; x < gridX; x++) {
                float xPos = (x * resolutionX) + mapXOffset;
                float yPos = (y * resolutionY) + mapYOffset;
                rc.setIndicatorDot(new MapLocation(xPos,yPos), 241, 255, 111);
            }
        }
    }
